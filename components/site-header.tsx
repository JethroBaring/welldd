...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-30 bg-background supports-backdrop-filter:bg-background/80 backdrop-blur flex h-16 shrink-0 items-center gap-2 border-b transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-16">
