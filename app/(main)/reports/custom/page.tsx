...
const DATA_SOURCES = [
  {
    ...
    description: "Current inventory stock levels and item details from DIGITS ERP",
    icon: "📦",
    category: "DIGITS ERP",
    fields: [
      ...
      { id: "expirationDate", label: "Expiration Date", type: "date" as const },
      { id: "batchNumber", label: "Batch Number", type: "string" as const },
    ],
  },
  {
    id: "inventory_transactions" as DataSourceType,
    name: "Inventory Transactions",
    description: "All inventory movements and transaction history from DIGITS ERP",
    icon: "📊",
    category: "DIGITS ERP",
    fields: [
      ...
      { id: "costCenter", label: "Cost Center", type: "string" as const },
    ],
  },
  {
    id: "purchase_orders" as DataSourceType,
    name: "Purchase Orders",
    description: "Procurement orders and spending analysis from DIGITS ERP",
    icon: "🛒",
    category: "DIGITS ERP",
    fields: [
      ...
      { id: "approvedBy", label: "Approved By", type: "string" as const },
      { id: "deliveryDate", label: "Delivery Date", type: "date" as const },
    ],
  },
  {
    id: "supplier_performance" as DataSourceType,
    name: "Supplier Performance",
    description: "Supplier delivery times, quality metrics, and contract compliance",
    icon: "🚚",
    category: "DIGITS ERP",
    fields: [
      { id: "supplierName", label: "Supplier Name", type: "string" as const },
      { id: "totalOrders", label: "Total Orders", type: "number" as const },
      { id: "onTimeDelivery", label: "On-Time Delivery %", type: "number" as const },
      { id: "qualityRating", label: "Quality Rating", type: "number" as const },
      { id: "averageLeadTime", label: "Avg Lead Time (days)", type: "number" as const },
      { id: "contractValue", label: "Contract Value", type: "currency" as const },
    ],
  },
  {
    id: "patients" as DataSourceType,
    name: "Patients",
    description: "Patient demographics and registration information from WellSync",
    icon: "👥",
    category: "WellSync",
    fields: [
      ...
      { id: "contactNumber", label: "Contact Number", type: "string" as const },
    ],
  },
  {
    id: "patient_consultations" as DataSourceType,
    name: "Patient Consultations",
    description: "Medical consultations and visit records from WellSync",
    icon: "🏥",
    category: "WellSync",
    fields: [
      { id: "consultationId", label: "Consultation ID", type: "string" as const },
      { id: "patientId", label: "Patient ID", type: "string" as const },
      { id: "consultationDate", label: "Date", type: "date" as const },
      { id: "physician", label: "Physician", type: "string" as const },
      { id: "chiefComplaint", label: "Chief Complaint", type: "string" as const },
      { id: "diagnosis", label: "Diagnosis", type: "string" as const },
      { id: "department", label: "Department", type: "string" as const },
    ],
  },
  {
    id: "prescriptions" as DataSourceType,
    name: "Prescriptions",
    description: "Prescription records and medication dispensing from WellSync",
    icon: "💊",
    category: "WellSync",
    fields: [
      { id: "prescriptionId", label: "Prescription ID", type: "string" as const },
      { id: "patientId", label: "Patient ID", type: "string" as const },
      { id: "medication", label: "Medication", type: "string" as const },
      { id: "dosage", label: "Dosage", type: "string" as const },
      { id: "quantity", label: "Quantity", type: "number" as const },
      { id: "prescribedDate", label: "Prescribed Date", type: "date" as const },
      { id: "dispensedDate", label: "Dispensed Date", type: "date" as const },
      { id: "physician", label: "Prescribing Physician", type: "string" as const },
    ],
  },
  {
    id: "disease_cases" as DataSourceType,
    name: "Disease Surveillance",
    description: "Disease surveillance and case tracking data from WellSync",
    icon: "🦠",
    category: "WellSync",
    fields: [
      { id: "caseId", label: "Case ID", type: "string" as const },
      ...
      { id: "outcome", label: "Outcome", type: "string" as const },
    ],
  },
];
...
const REPORT_TEMPLATES: ReportTemplate[] = [
  ...
  },
  {
    ...
    description: "Supplier metrics and contract compliance tracking",
    icon: "🚚",
    category: "DIGITS ERP",
    dataSource: "supplier_performance",
    presetFields: ["supplierName", "totalOrders", "onTimeDelivery", "qualityRating"],
    usageCount: 134,
  },
  {
    id: "tmpl-7",
    name: "Prescription Fulfillment",
    description: "Prescription dispensing and medication tracking",
    icon: "💊",
    category: "WellSync",
    dataSource: "prescriptions",
    presetFields: ["medication", "quantity", "prescribedDate", "dispensedDate"],
    usageCount: 267,
  },
  {
    id: "tmpl-8",
    name: "Consultation Summary",
    description: "Medical consultation patterns and physician workload",
    icon: "🏥",
    category: "WellSync",
    dataSource: "patient_consultations",
    presetFields: ["consultationDate", "physician", "diagnosis", "department"],
    usageCount: 198,
  },
];
